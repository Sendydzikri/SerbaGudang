...
<head>
    <meta charset="utf-8">
    <title>Menu Utama Supplier</title>
...
<body class="bg-light">
    ...
    <div id="sideNavigation" class="sidenav">
        ...
        <a href="<?php echo base_url('Supplier') ?>"><img
                src="<?php echo base_url('assets/image/home.png'); ?>" class="gk" width="30" height="30">Dashboard</a>
        <a href="<?= base_url('Supplier/Laporan'); ?>"><img src="<?php echo base_url('assets/image/laporan.png'); ?>" class="gk"
